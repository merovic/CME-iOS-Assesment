//
//  cme_ios_technical_assessmentTests.swift
//  cme-ios-technical-assessmentTests
//
//  Created by Amir Morsy on 01/02/2025.
//

import Foundation
import XCTest
import Combine
@testable import cme_ios_technical_assessment

class DummyRestCountriesRepository: RestCountriesRepository {
    var response: RESTCountriesAPIResponse?
    var error: Error?
    
    func getAllCountries() -> AnyPublisher<cme_ios_technical_assessment.RESTCountriesAPIResponse, any Error> {
        if let error = error {
